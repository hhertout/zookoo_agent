...
pub fn build(b: *std.Build) void {
    ...
    //const mod = b.addModule("zookoo_agent", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            //.imports = &.{
            //    // Here "zookoo_agent" is the name you will use in your source code to
            //    // import this module (e.g. `@import("zookoo_agent")`). The name is
            //    // repeated because you are allowed to rename your imports, which
            //    // can be extremely useful in case of collisions (which can happen
            //    // importing modules from different packages).
            //    .{ .name = "zookoo_agent", .module = mod },
            //},
        }),
    });
    ...
    const otel_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/exporters/otel_test.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const memory_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/collectors/memory.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
